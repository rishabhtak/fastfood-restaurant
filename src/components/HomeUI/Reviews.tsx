...
const Reviews = () => {
  const responsive = {
    ...
    desktop: {
      breakpoint: { max: 8000, min: 465 },
      items: 1,
    },
  };
  return (
    <>
      <SectionTitle title={"What Says Our Customers"} />
      <Carousel
      ...
      >
        <div className="flex flex-col items-center pb-16">
          ...
          <div className="mt-8">
            <p className="max-w-4xl font-normal text-lg text-center text-[#666666] mx-auto">
          ...
          <div className="text-[#ec1d25] flex justify-center mt-3 text-lg">
            <svg
