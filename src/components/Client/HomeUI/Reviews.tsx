...
const Reviews = () => {
  ...
  const [triggerAnim, setTriggerAnim] = useState<number>(0);
    ...
    <>
      ...
      >
        <div className="flex flex-col items-center pb-16">
          <animated.div
            style={imageSprings}
            className="rounded-full overflow-hidden border-4 border-solid border-[#ec1d25] size-28 mx-auto"
          >
            <Image
              src={"/avatar-01.webp"}
              alt="review-1"
          ...
          <animated.div style={delaySprings}>
            <div className="mt-8">
